...
namespace eSyaAppointmentPortal.IF
{
    public interface IAppointmentBookingRepository
    {
        ...
        Task<List<DO_Doctor>> GetDoctorScheduleByBKeyDoctorDate(int businessKey, int clinicType, int consultationType, int specialtyId, int doctorId, DateTime appointmentDate);
